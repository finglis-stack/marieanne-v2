...
import { Coffee, Eye, EyeOff, Loader2, MonitorPlay, Shield } from 'lucide-react';
...
export const FuturisticLogin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Étape 5 : Compte déverrouillé = Enregistrer automatiquement
      const registered = await registerDevice(data.user.id);
