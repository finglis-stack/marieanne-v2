...
export const FuturisticLogin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!authorized) {
        // Appareil non reconnu : afficher le dialogue de sécurité
  ...
  return (
    <>
      ...
      {/* Dialogue de sécurité pour appareil non reconnu */}
        ...
        <DialogContent className="backdrop-blur-xl bg-slate-900/95 border-orange-500/30 text-white">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-300">
              Cet appareil n'a jamais été utilisé pour se connecter à ce compte.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-orange-500/10 border border-orange-500/30 rounded-lg">
              ...
              <p className="text-gray-300 text-sm">
                Pour protéger votre compte, seuls les appareils autorisés peuvent se connecter. 
                Si c'est bien vous qui essayez de vous connecter, autorisez cet appareil.
              </p>
            </div>
