...
export const ProductCard = ({ product, onRefresh }: ProductCardProps) => {
  ...
  return (
    <>
      <Card className="backdrop-blur-xl bg-slate-900/60 border-blue-500/20 overflow-hidden group hover:border-blue-400/50 transition-all hover:scale-105">
